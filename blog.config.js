...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是ZZHow!,Hi，我是一个网工人, Hi，我是一个BISTUer,Hi，我是一个程序员,欢迎来到ZZHow的主站🎉',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zzhow.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ZZHow, 主站', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'ZZHow', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'ZZHow主站', // 站点描述，被notion中的页面描述覆盖
